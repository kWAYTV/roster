    ...
    <ContextMenuPrimitive.Portal>
      ...
      >
        <ContextMenuPrimitive.Popup
          className={cn(
            "data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:fade-in-0 data-open:zoom-in-95 data-closed:fade-out-0 data-closed:zoom-out-95 z-50 max-h-(--available-height) min-w-48 origin-(--transform-origin) overflow-y-auto overflow-x-hidden rounded-md bg-popover p-1 text-popover-foreground shadow-md outline-none ring-1 ring-foreground/8 duration-150 data-closed:animate-out data-open:animate-in",
            className
          )}
...
function ContextMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      {showChevron ? <ChevronRightIcon className="ml-auto" size={16} /> : null}
    </ContextMenuPrimitive.SubmenuTrigger>
  );
}
...
function ContextMenuSubContent({
  ...
  return (
    <ContextMenuContent
      align={align}
      className={cn("min-w-40 shadow-lg", className)}
